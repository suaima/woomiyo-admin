                  ...
                  <div className="col-md-6">
                    <Form.Group className="row">
                      ...
                      <div className="col-sm-9">
                        <Form.Control type="text" value="Jhon" />
                      </div>
                    </Form.Group>
                  </div>
                  <div className="col-md-6">
                ...
                <div className="row">
                  ...
                  <div className="col-md-6">
                    <Form.Group className="row">
                      ...
                      <div className="col-sm-9">
                        <Form.Control type="text" value="Rajasthan" />
                      </div>
                    </Form.Group>
                  </div>
                </div>
                <div className="row">
                  <div className="col-md-6">
                    <Form.Group className="row">
                      ...
                      <div className="col-sm-9">
                        <Form.Control type="text" value="Address line 2" />
                      </div>
                    </Form.Group>
                  </div>
                  <div className="col-md-6">
                    <Form.Group className="row">
                      ...
                      <div className="col-sm-9">
                        <Form.Control type="text" value="302018" />
                      </div>
                    </Form.Group>
                  </div>
                </div>
                <div className="row">
                  <div className="col-md-6">
                    <Form.Group className="row">
                      ...
                      <div className="col-sm-9">
                        <Form.Control type="text" value="Jaipur" />
                      </div>
                    </Form.Group>
                  </div>
                  <div className="col-md-6">
