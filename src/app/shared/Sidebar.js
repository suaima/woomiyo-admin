    ...
    return (
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        <ul className="nav">
          ...
          <li className={ this.isPathActive('/callbacks') ? 'nav-item active' : 'nav-item' }>
            <Link className="nav-link" to="/callbacks">
              <span className="menu-title"><Trans>Callbacks</Trans></span>
              <i className="mdi mdi-home menu-icon"></i>
            </Link>
          </li>
          <li className={ this.isPathActive('/parkedcalls') ? 'nav-item active' : 'nav-item' }>
            <Link className="nav-link" to="/parkedcalls">
              <span className="menu-title"><Trans>Parked Calls</Trans></span>
              <i className="mdi mdi-home menu-icon"></i>
            </Link>
          </li>
          ...
          <li className={ this.isPathActive('/recordings') ? 'nav-item active' : 'nav-item' }>
            <Link className="nav-link" to="/recordings">
              <span className="menu-title"><Trans>Recordings</Trans></span>
              <i className="mdi mdi-home menu-icon"></i>
            </Link>
          </li>

          <li className={ this.isPathActive('/quality-feedback') ? 'nav-item active' : 'nav-item' }>
            <Link className="nav-link" to="/quality-feedback">
              <span className="menu-title"><Trans>Quality Feedback</Trans></span>
              <i className="mdi mdi-home menu-icon"></i>
            </Link>
          </li>
